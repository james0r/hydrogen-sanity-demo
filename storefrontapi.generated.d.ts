...
export type CollectionDetailsIdQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
...
export type CollectionDetailsIdQuery = {
  collection?: StorefrontAPI.Maybe<
    Pick<
      StorefrontAPI.Collection,
      'id' | 'title' | 'description' | 'handle'
...
export type ProductsAndVariantsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  ids:
...
export type ProductsAndVariantsQuery = {
  products: Array<
    StorefrontAPI.Maybe<
      Pick<StorefrontAPI.Product, 'handle' | 'id' | 'title' | 'vendor'> & {
        options: Array<Pick<StorefrontAPI.ProductOption, 'name' | 'values'>>;
...
export type ProductAndVariantQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  id: StorefrontAPI.Scalars['ID']['input'];
...
export type ProductAndVariantQuery = {
  product?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Product, 'handle' | 'id' | 'title' | 'vendor'> & {
      options: Array<Pick<StorefrontAPI.ProductOption, 'name' | 'values'>>;
    }
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n\n  query CollectionDetailsId($country: CountryCode, $language: LanguageCode, $id: ID!, $count: Int!, $cursor: String, $sortKey: ProductCollectionSortKeys, $reverse: Boolean)\n    @inContext(country: $country, language: $language) {\n    collection(id: $id) {\n      ...CollectionFields\n    }\n  }\n  #graphql\n  fragment ProductFields on Product {\n    handle\n    id\n    options {\n      name\n      values\n    }\n    title\n    vendor\n  }\n\n  #graphql\n  fragment ProductVariantFields on ProductVariant {\n    availableForSale\n    compareAtPrice {\n      currencyCode\n      amount\n    }\n    id\n    image {\n      altText\n      height\n      id\n      url\n      width\n    }\n    price {\n      currencyCode\n      amount\n    }\n    selectedOptions {\n      name\n      value\n    }\n    title\n    sku\n    unitPrice {\n      amount\n      currencyCode\n    }\n    product {\n      title\n      handle\n    }\n  }\n\n  #graphql\n  fragment CollectionFields on Collection {\n    id\n    title\n    description\n    handle\n    products(first: $count, after: $cursor, sortKey: $sortKey, reverse: $reverse) {\n      pageInfo {\n        hasNextPage\n        endCursor\n      }\n      nodes {\n        ...ProductFields\n        variants(first: 1) {\n          nodes {\n            ...ProductVariantFields\n          }\n        }\n      }\n    }\n  }\n\n': {
    return: CollectionDetailsIdQuery;
    variables: CollectionDetailsIdQueryVariables;
  };
  ...
  '#graphql\n  query productsAndVariants(\n    $country: CountryCode\n    $language: LanguageCode\n    $ids: [ID!]!\n    $variantIds: [ID!]!\n  ) @inContext(country: $country, language: $language) {\n    products: nodes(ids: $ids) {\n      ... on Product {\n        ...ProductFields\n      }\n    }\n    productVariants: nodes(ids: $variantIds) {\n      ... on ProductVariant {\n        ...ProductVariantFields\n      }\n    }\n  }\n  #graphql\n  fragment ProductFields on Product {\n    handle\n    id\n    options {\n      name\n      values\n    }\n    title\n    vendor\n  }\n\n  #graphql\n  fragment ProductVariantFields on ProductVariant {\n    availableForSale\n    compareAtPrice {\n      currencyCode\n      amount\n    }\n    id\n    image {\n      altText\n      height\n      id\n      url\n      width\n    }\n    price {\n      currencyCode\n      amount\n    }\n    selectedOptions {\n      name\n      value\n    }\n    title\n    sku\n    unitPrice {\n      amount\n      currencyCode\n    }\n    product {\n      title\n      handle\n    }\n  }\n\n': {
    return: ProductsAndVariantsQuery;
    variables: ProductsAndVariantsQueryVariables;
  };
  '#graphql\n  query productAndVariant(\n    $country: CountryCode\n    $language: LanguageCode\n    $id: ID!\n    $variantId: ID!\n  ) @inContext(country: $country, language: $language) {\n    product: product(id: $id) {\n      ...ProductFields\n    }\n    productVariant: node(id: $variantId) {\n      ... on ProductVariant {\n        ...ProductVariantFields\n      }\n    }\n  }\n  #graphql\n  fragment ProductFields on Product {\n    handle\n    id\n    options {\n      name\n      values\n    }\n    title\n    vendor\n  }\n\n  #graphql\n  fragment ProductVariantFields on ProductVariant {\n    availableForSale\n    compareAtPrice {\n      currencyCode\n      amount\n    }\n    id\n    image {\n      altText\n      height\n      id\n      url\n      width\n    }\n    price {\n      currencyCode\n      amount\n    }\n    selectedOptions {\n      name\n      value\n    }\n    title\n    sku\n    unitPrice {\n      amount\n      currencyCode\n    }\n    product {\n      title\n      handle\n    }\n  }\n\n': {
    return: ProductAndVariantQuery;
    variables: ProductAndVariantQueryVariables;
  };
